...
class WorkTable extends React.Component {
  ...
  getMyProject = () => {
    const that = this;
    this.$http.get(url.url + '/v1/index/getMyUserProject')
              ...
              >
                ...
                <Card.Content>
                  ...
                  >
                    ...
                    <Table.Column title="优先级" dataIndex="level" cell={this.renderLevel} width={150}/>
                  </Table>
                </Card.Content>
              </Card>
            </Cell>
            ...
            <Cell colSpan={4}>
              ...
              >
                ...
                <Card.Content>
                  <List>
                    {
                      Array.isArray(this.state.myProjects)
